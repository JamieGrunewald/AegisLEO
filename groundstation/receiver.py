...
Protocol
--------
This receiver now supports a two-phase protocol:
...
Why this matters
----------------
This keeps telemetry packets much smaller over the LoRa link.
That makes the radio path more reliable and avoids sending the
large KEM ciphertext on every packet.
"""
...
while True:
    ...
    try:
        ...
        # -------------------------------------------------------------
        # Step 2: Handle session_init packets
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # Step 3: Handle telemetry packets
        # -------------------------------------------------------------
